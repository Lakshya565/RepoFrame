...
_SYSTEM_PROMPT = (
    ...
    "marketing language.\n"
    "- Honor the user context's guardrails: never make a claim it says to avoid, "
    "even if the evidence might otherwise support it. When the user names a "
    "technical focus, emphasize those areas (as long as the evidence backs them).\n"
